/**
 * Visor de imágenes compartido — zoom, pan, galería.
 * Registra window.ISAFront.Lightbox (ImageLightboxDialog, LightboxImage, useImageLightboxZoom).
 */
(function () {
  "use strict";
  ...
  function resolveUi(ns) {
    ...
    throw new Error("ImageLightbox: UI.Icon no disponible — ejecutar ISAFront.registerApp antes");
  }
...
function PanPad({ canPan, panBy, Icon }) {
...
function useImageLightboxZoom(open, slideKey) {
  const { useState, useCallback, useEffect, useRef } = getReact();
...
function GalleryDots({ count, index, onSelect }) {
  ...
  function ImageLightboxDialog({
    ...
    } = useImageLightboxZoom(open, slideKey);
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(PanPad, { canPan, panBy, Icon }),
            React.createElement(Box, { className: "isa-lb-zoom__toolbar-divider" }),
            React.createElement(IconButton, {
  ...
  function LightboxZoomInline({
    ...
    return React.createElement(
      ...
      React.createElement(ImageLightboxDialog, {
        ns: ns,
        open: open,
  ...
  function LightboxZoomInlineHost({ ns }) {
    ...
    return React.createElement(ImageLightboxDialog, {
      ns: state.ns,
      open: state.open,
